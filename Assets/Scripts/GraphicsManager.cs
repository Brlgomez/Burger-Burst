...
public class GraphicsManager : MonoBehaviour {
	...
	void Awake()
	{
        ...
        graphicList.Add(classicColor = new Graphic(2, 0, "Classic color", graphicSprites[2]));
        graphicList.Add(blackAndWhite = new Graphic(3, 0, "Black & white", graphicSprites[3]));
        graphicList.Add(noir = new Graphic(4, 0, "Noir", graphicSprites[4]));
	}
}
